Feature: Create Trainer Account in Admin Module
    ...
    Background:
        Given the admin logs into the application
        And the admin navigates to the Trainers page

    @Vithya @CreateTrainerValidDetails
    ...
    @Vithya @CreateTrainerMandatoryFields
    ...
    @Vithya @CreateTrainerConfirmPasswordRequired
    ...
    @Vithya @CreateTrainerInvalidEmail
    ...
    @Vithya @CreateTrainerPasswordMismatch
